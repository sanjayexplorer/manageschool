<footer>
    <div class="footer_container bg-[#222937] py-10 lg:py-[80px]">
        <div class="wrapper">
            <div class="footer_inner">
                <div class="footer_content flex flex-col lg:flex-row mx-[-20px]">

                    <div class="footer_content_tt w-full lg:w-[26%] px-[20px]">
                    ...
                    <div class="footer_content_tt w-full lg:w-[37%] px-[20px]">
                        <div class="w-[100%]">
                        <div class="footer_h mb-5">
                            <h3
                                class="text-left border-b-[4px] border-b-[#A73335] text-[#fff] capitalize inline-block text-[21px]">
