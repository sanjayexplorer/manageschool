    ...
    <div class="flex justify-between items-center pb-5">
            <div class="list-header">
                <div class="flex items-center justify-start">
                    ...
                    <h2 class="font-normal text-2xl">Add New Teacher</h2>
                </div>
            </div>
    </div>
    <div class="w-full rounded-md">
        <form action="{{route('admin.teachers.store')}}" method="post" class="flex flex-col"
            ...
            <div class="basic-information">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                   ...
                   <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <input type="text" name="first_name" id="first_name" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" value="{{old('first_name')}}"
                   ...
                   <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{old('last_name')}}" data-error-msg="Last name is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{old('phone')}}" data-error-msg="Phone is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <!-- Phone -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        <label for="date_of_birth" class="text-sm text-gray-600 mb-2 block">Date of Birth<span class="mandatory">*</span></label>
                        <input type="text" name="date_of_birth" id="date_of_birth" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields"
                        value="{{old('date_of_birth')}}" data-error-msg="Date of birth is required." readonly/>
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                
                <div class="input-group w-full mb-4">
                    <label for="status" class="text-sm text-gray-600 mb-2 block">Status<span class="mandatory">*</span></label>
            ...
            <div class="basic-information">
                ...
                <!-- Roll Number -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        <label for="qualification" class="text-sm text-gray-600 mb-2 block">Qualification<span class="mandatory">*</span></label>
                        <input type="text" name="qualification" id="qualification" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" value="{{old('qualification')}}" data-error-msg="Qualification is required."  />
                        <span class="scrollForReq error-message"></span>
                    </div>

                    <!-- Admission Date -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        <label for="specialization" class="text-sm text-gray-600 mb-2 block">Specialization<span class="mandatory">*</span></label>
                        <input type="text" name="specialization" id="specialization" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields"
                        value="{{old('specialization')}}" data-error-msg="Specialization is required."/>
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
            </div>
