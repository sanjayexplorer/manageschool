            ...
            <form action="{{route('admin.students.store')}}" method="post" class="flex flex-col"
                ...
                <div class="basic-information">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                        ...
                        <div class="input-group w-full md:w-1/2 mb-4">
                            ...
                            <input type="text" name="first_name" id="first_name"
                                ...
                                value="" data-error-msg="First name is required." />
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                        ...
                        <!-- Phone -->
                        <div class="input-group w-full md:w-1/2 mb-4">
                            <label for="dob" class="text-sm text-gray-600 mb-2 block">Date of Birth<span
                                    class="mandatory">*</span></label>
                ...
                <div class="basic-information">
                    ...
                    <div class="input-group w-full mb-4">
                        <label for="address_line_1" class="text-sm text-gray-600 mb-2 block">Address Line 1<span
                                class="mandatory">*</span></label>
                        <textarea name="address_line_1" id="address_line_1"
                            class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields"
                            rows="3" placeholder="Enter Address Line 1"
                            data-error-msg="Address Line 1 is required."></textarea>
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="basic-information">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                        <!-- Class -->
                        <div class="input-group w-full md:w-1/2 mb-4">
                            <label for="class_id" class="text-sm text-gray-600 mb-2 block">Class<span
                                    class="mandatory">*</span></label>
                            <select name="class_id" id="class_id"
                                class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields"
                                data-error-msg="Class is required.">
                                <option value="" selected>Select Class</option>
                                @foreach($classes as $class)
                                    {{$class->students}}
                                    <option value="{{ $class->id }}" data-student-count="{{ $class->students->count() }}">
                                        {{ $class->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <!-- Admission Date -->
                        <div class="input-group w-full md:w-1/2 mb-4">
                            <label for="admission_date" class="text-sm text-gray-600 mb-2 block">Admission Date<span
                                    class="mandatory">*</span></label>
                ...
                <div class="address-information">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                        ...
                        <div class="input-group w-full md:w-1/2 mb-4">
                            <label for="guardian_relation" class="text-sm text-gray-600 mb-2 block">Relationship to
                                Student</label>
                ...
                <div class="w-full">
                    <!-- Submit Button -->
                    <button type="submit"
                        class="p-[0.95rem] bg-gray-700 text-white text-base border-none rounded-md cursor-pointer transition-all duration-300 mt-4 mb-4 w-full uppercase">SAVE</button>
                </div>
            </form>
        </div>
    </div>
