    ...
    <div class="flex justify-between items-center pb-5">
            <div class="list-header">
                <div class="flex items-center justify-start">
                    ...
                    <h2 class="font-normal text-2xl">Edit Student Details</h2>
                </div>
            </div>
    </div>
    <div class="w-full rounded-md">
        <form action="{{route('admin.students.update',$student->id)}}" method="post" class="flex flex-col"
            ...
            <div class="basic-information">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                   ...
                   <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <input type="text" name="first_name" id="first_name" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" value="{{$student->first_name}}"
                   ...
                   <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{$student->last_name}}" data-error-msg="Last name is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{$student->email}}" data-error-msg="Email is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                    <!-- Phone -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{$student->phone}}" data-error-msg="Phone is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <select name="gender" id="gender" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" data-error-msg="Gender is required.">
                            ...
                            <option value="male" @if(strcmp($student->gender, 'male') == 0) selected @endif>Male</option>
                            <option value="female" @if(strcmp($student->gender, 'female') == 0) selected @endif>Female</option>
                            <option value="other" @if(strcmp($student->gender, 'other') == 0) selected @endif>Other</option>
                        </select>
                        <span class="scrollForReq error-message"></span>
                    </div>
                    <!-- Phone -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{$student->dob}}" data-error-msg="Date of birth is required." readonly/>
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="input-group w-full mb-4">
                    ...
                    <select name="status" id="status" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" data-error-msg="Status is required.">
                        ...
                        <option value="active" @if(strcmp($student->status, 'active') == 0) selected @endif>Active</option>
                        <option value="inactive" @if(strcmp($student->status, 'inactive') == 0) selected @endif>Inctive</option>
                    </select>
                    <span class="scrollForReq error-message"></span>
                </div>
            </div>
            ...
            <div class="basic-information">
                ...
                <div class="input-group w-full mb-4">
                    ...
                    <textarea name="address_line_1" id="address_line_1" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" 
                            rows="3" placeholder="Enter Address Line 1" data-error-msg="Address Line 1 is required.">{{$student->address_line_1}}</textarea>
                    <span class="scrollForReq error-message"></span>
                </div>
            </div>
            ...
            <div class="basic-information">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <select name="class_id" id="class_id" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" data-error-msg="Class is required.">
                            ...
                            <option value="{{ $class->id }}" @if(strcmp($student->class_id, $class->id) == 0) selected @endif>{{ $class->name }}</option>
                           @endforeach
                        </select>
                        <span class="scrollForReq error-message"></span>
                    </div>
                         ...
                         @foreach($classes as $class)
                            @if($class->id == $student->class_id)
                                @foreach($class->sections as $section)
                                    <option value="{{ $section->id }}" @if(strcmp($student->section_id, $section->id) == 0) selected @endif>Section {{ $section->name }}</option>
                                @endforeach
                            @endif
                         @endforeach
                        </select>
                ...
                <!-- Roll Number -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <input type="text" name="roll_number" id="roll_number" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" value="{{$student->roll_number}}" data-error-msg="Roll number is required." />
                        <span class="scrollForReq error-message"></span>
                    </div>
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        value="{{$student->admission_date}}" data-error-msg="Admission date is required." readonly/>
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="address-information">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <input type="text" name="guardian_name" id="guardian_name" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none" value="{{$student->guardian_name}}"/>
                    </div>
                    <!-- Guardian's Relationship -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        <label for="guardian_relation" class="text-sm text-gray-600 mb-2 block">Relationship to Student</label>
                        <input type="text" name="guardian_relation" id="guardian_relation" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none" value="{{$student->guardian_relation}}"/>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-between gap-[10px]">
                    ...
                    <div class="input-group w-full md:w-1/2 mb-4">
                        ...
                        <input type="text" name="guardian_email" id="guardian_email" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none" value="{{$student->guardian_email}}"/>
                    </div>
                    <!-- Guardian's Phone -->
                    <div class="input-group w-full md:w-1/2 mb-4">
                        <label for="guardian_phone" class="text-sm text-gray-600 mb-2 block">Guardian's Phone</label>
                        <input type="text" name="guardian_phone" id="guardian_phone" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none" value="{{$student->guardian_phone}}"/>
                    </div>
                </div>
            </div>
